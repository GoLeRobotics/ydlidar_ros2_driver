...
int main(int argc, char *argv[]) {
  ...
  laser.getlidaropt(LidarPropIntenstiyBit, &optval, sizeof(int));
  RCLCPP_WARN_STREAM(node->get_logger(), "    - After setting: " << optval);
  ...
  // node->get_parameter("invalid_range_is_inf", b_optvalue);
